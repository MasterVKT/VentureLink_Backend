# Règles AI pour VentureLink Backend

> **Note** : Ce fichier contient les règles de base pour les agents AI. Une version consolidée et complète est disponible dans [`.github/copilot-instructions.md`](../../.github/copilot-instructions.md) pour GitHub Copilot.
...
Consultez le fichier consolidé : [`.github/copilot-instructions.md`](../../.github/copilot-instructions.md)